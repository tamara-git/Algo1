...
class Test_atencion_a_clientes(unittest.TestCase):
    def con_una_prioridad(self):
        ...
        cola.put(tuple["Pablo",47344554,False,True])
        cola.put(tuple["Brunilda", 94256891, False, True])
        cola.put(tuple["Kiara", 10245697, True, False])
        cola.put(tuple["Tamara", 46683766, False, False])

        cola_ordenada: Cola[tuple[str,int,bool,bool]] = Cola()
        cola_ordenada.put(tuple["Kiara", 10245697, True, False])
        cola_ordenada.put(tuple["Pablo",47344554,False,True])
        cola_ordenada.put(tuple["Brunilda", 94256891, False, True])
        cola_ordenada.put(tuple["Tamara", 46683766, False, False])
