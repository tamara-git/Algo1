...
mayorCantidadDeApariciones [x] | (cantidadDeApariciones e x > cantidadDeApariciones y x) = e
                               | otherwise = y
mayorCantidadDeApariciones (x:xs) | cantidadDeAparicionesTablero e (x:xs) > cantidadDeAparicionesTablero y (x:xs) = e
                                  | otherwise = y
